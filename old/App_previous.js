...
function LoginPage() {
  ...
  const quickLogin = (role) => {
    const users = {
      admin: { email: 'admin@vmart.com', password: 'admin123' },
      delivery: { email: 'delivery@vmart.com', password: 'delivery123' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-400 to-blue-500 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">vmart</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-green-600">vmart</h1>
